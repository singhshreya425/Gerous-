...
// Given a [info message="A doubly linked list is a set of dynamically allocated nodes, arranged in such a way that each node contains one value and two pointers. The one pointer points to the next member of the list and another to the previous one. If the next pointer is NULL, then it is the last node in the list and the previous pointer is NULL, then it is the first node in the list."]Doubly Linked List[/info], insert a new node at the end.
